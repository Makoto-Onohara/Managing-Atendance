...
public final class ExcelColor {
     ...
     */
    // ヘッダー白文字
    public static final byte[] furikaeWhite = new byte[]{(byte)255, (byte)255, (byte)255};
    public static final XSSFColor FURIKAE_WHITE = new XSSFColor(furikaeWhite, new DefaultIndexedColorMap());
    // ヘッダー「振替出勤」
